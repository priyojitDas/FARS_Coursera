...
#' 
#' @examples
#' fars_read(filename = "accident_1992.csv.bz2")
#' 
#' @export
...
#' 
#' @examples
#' fars_read_years(years = c(1992,1993,1994))
#' 
#' @export
...
#' 
#' @examples
#' fars_summarize_years(years = c(1992,1993,1994))
#' 
#' @export
...
#' 
#' @examples
#' fars_map_state(state.num = 12, year = 1994)
#' 
#' @export
